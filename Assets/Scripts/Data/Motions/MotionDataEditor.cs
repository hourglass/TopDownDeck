...
public class MotionDataEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // 기본 속성 표시
        SerializedProperty motionStep = serializedObject.FindProperty("motionStep");
        SerializedProperty motionTime = serializedObject.FindProperty("motionTime");

        EditorGUILayout.PropertyField(motionStep);
